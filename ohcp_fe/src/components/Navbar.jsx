                        ...
                        <ul className="nav-menu d-none d-lg-flex m-0">
                            ...
                            >
                                <span className="nav-link dropdown-toggle">
                                    Services <i className="fas fa-chevron-down ms-1"></i>
                                </span>
                                {servicesDropdownOpen && (
                                    <ul className="dropdown-menu-custom">
                                        <li><NavLink to="/records" className="dropdown-item-custom">Records</NavLink></li>
                                        <li><NavLink to="/video" className="dropdown-item-custom">Video Call</NavLink></li>
                                        <li><NavLink to="/chat" className="dropdown-item-custom">Chat</NavLink></li>
                                    </ul>
                                )}
                            </li>
