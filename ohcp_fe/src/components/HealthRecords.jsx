                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <div className="d-flex gap-3 overflow-auto pb-3" style={{ scrollbarWidth: 'thin' }}>
                                                        {medicalHistory.doctorVisits.map(doctor => (
                                                            <div key={doctor.doctorID} className="card border-0 shadow-sm rounded-3 flex-shrink-0" style={{ minWidth: '280px', maxWidth: '280px' }}>
                                                    ...
                                                    <div key={apt.appointmentID} className="card border hover-shadow transition-all rounded-3">
                                                        <div className="card-body">
                                                            <div className="row align-items-center g-3 mb-3">
                                                                ...
                                                                <div className="col-auto">
                                                                    <button className="btn btn-outline-primary btn-sm rounded-pill px-3" onClick={() => handleViewAppointmentDetail(apt.appointmentID)}>
                                                            ...
                                                            {apt.consultation && apt.consultation.diagnosis && (
                                                                <div className="mb-3 p-3 bg-info-subtle rounded-3 border-start border-info border-4">
                                                                    ...
                                                                    {apt.consultation.diagnosis.length > 100 && (
                                                                        <button className="btn btn-link btn-sm p-0 mt-1 text-info text-decoration-none" onClick={() => toggleCardExpand(apt.appointmentID)}>
                                                            ...
                                                            {apt.prescription && apt.prescription.medicationNames && apt.prescription.medicationNames.length > 0 && (
                                                                <div className="p-3 bg-success-subtle rounded-3 border-start border-success border-4">
                                                                    ...
                                                                    {apt.prescription.medicationNames.length > 5 && (
                                                                        <button className="btn btn-link btn-sm p-0 mt-2 text-success text-decoration-none" onClick={() => toggleCardExpand(apt.appointmentID)}>
                                                                            {expandedCards[apt.appointmentID] ? (
